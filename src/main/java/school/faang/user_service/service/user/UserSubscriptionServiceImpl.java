...
public class UserSubscriptionServiceImpl implements UserSubscriptionService {
    ...
    private Stream<User> filterUsers(Stream<User> userStream, UserFiltersDto filters) {
        ...
        return userStream
                .filter(user -> filters.namePattern() == null || filters.namePattern().isBlank() ||
                        (user.getUsername() != null && user.getUsername().toLowerCase().contains(filters.namePattern().toLowerCase())))
                .filter(user -> filters.phonePattern() == null || filters.phonePattern().isBlank() ||
